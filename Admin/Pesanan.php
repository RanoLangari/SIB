                            ...
                            <table class="table table-bordered">
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <button data-toggle="modal" data-target="#edit<?= $row["id_pesanan"]; ?>" class="btn btn-warning">Edit</button> <br>
                                            <button data-toggle="modal" data-target="#hapus<?= $row["id_pesanan"]; ?>" class="btn btn-danger">Hapus</button>
                                        </td>
                                    </tr>
                                    <!-- Modal Edit Data -->
